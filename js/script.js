...
const langArr = {
  ...
  'about-alltext' :{
    'ru':'<span>Основоное:</span>  Назаров Максим Сергеевич, родился в 05.10.2002 г., живу в Москве, гражданство РФ. <br> <span>Образование:</span> На данный момент перехожу на 4 курс в ГАПОУ ТК №24 (Специальность: Информационные системы и программирование). <br> <span>Работа:</span> На данный момент работаю в студии "TURILOV proj", брал разные заказы. Не готов стоять на месте, постоянно развиваюсь и поэтому ищу новую работу.<br> <span>Должность:</span> Фронтенд разработчик. Зарплатная вилка от 50к и более. Опыт работы, а также коммерческий опыт 10 месяцев.<br> <span>Интересы:</span> Предпочитаю активный отдых, любой спорт, люблю путешествовать и ходить в походы.',
    'en':'<span>Basic:</span>  Nazarov Maxim Sergeevich, was born on 05.10.2002, I live in Moscow, citizenship of the Russian Federation. <br> <span>Education:</span> At the moment, I am moving to the 4th year at GAPOU TC No. 24 (Specialty: Information systems and programming). <br> <span>Work:</span> At the moment I work in the studio "TURILOV proj", took different orders. I am not ready to stand still, I am constantly developing and therefore I am looking for a new job.<br> <span>Position:</span> Frontend developer. Salary fork from 50k and more. Work experience, as well as commercial experience of 10 months.<br> <span>Interests:</span> I prefer active recreation, any sport, I like to travel and go hiking.',
},
'myworks ':{
    'ru':'<h1>Мои работы</h1>',
    'en':'<h1>My works</h1>',

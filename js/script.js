...
const langArr = {
  ...
  language: {
    ru: 'English <span aria-hidden>_</span> <span aria-hidden class="cybr-btn__glitch">Language</span><span aria-hidden class="cybr-btn__tag">R25</span>',
    en: 'Russian <span aria-hidden>_</span> <span aria-hidden class="cybr-btn__glitch">Язык</span><span aria-hidden class="cybr-btn__tag">R25</span>',
  },
  vkontakte: {
  ...
  'about-alltext': {
    ru: '<span>Основоное:</span> Назаров Максим Сергеевич, родился в 05.10.2002 г., живу в Москве, гражданство РФ. <br><span>Образование:</span> ГАПОУ ТК № 24 Среднее профессиональное образование "Информационные системы и программирование" (Очная форма обучения)<br><span>Опыт работы:</span> ИП "TURILOV media", Фронтенд-Разработчик (Частично фулстак) | Фриланс<br> <span>Дополнительная информация:</span> Полный пакет Office | Photoshop + Figma |',
    en: '<span>Basic:</span> Nazarov Maxim Sergeevich, was born on 05.10.2002, I live in Moscow, citizenship of the Russian Federation. <br><span>Education:</span> GAPOU TC No. 24 Secondary vocational education "Information systems and programming" (Full-time education)<br><span>Work experience:</span> IP "TURILOV media", Frontend Developer (Partially fullstack) | Freelance<br> <span>Additional information:</span> Full Office Package | Photoshop + Figma |',
  },
  'myworks ': {
    ru: '<h1>Мои работы</h1>',
    en: '<h1>My works</h1>',
